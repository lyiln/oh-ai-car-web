...
| [`003-patrol-inspection/`](003-patrol-inspection/) | 巡检、白名单、识别、审核与微信通知 API（兼容历史上门任务） | [`spec.md`](003-patrol-inspection/spec.md)、[`contracts/patrol-api.md`](003-patrol-inspection/contracts/patrol-api.md)、[`quickstart.md`](003-patrol-inspection/quickstart.md) |

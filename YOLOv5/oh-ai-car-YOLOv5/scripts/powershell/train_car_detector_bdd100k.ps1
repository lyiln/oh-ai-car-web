param(
    ...
    [string]$DataYaml = "C:\Users\jfkyx\Desktop\YOLOv5 plate\member_d_plate_detection\configs\car_bdd100k_vehicle.yaml",
    [int]$ImgSize = 640,
    [int]$BatchSize = 8,
    [int]$Epochs = 50,
    [string]$Device = "0",
    [string]$RunName = "car_bdd100k_vehicle_v1",
    [int]$Workers = 2
)
...
Write-Host "BDD100K vehicle training finished."

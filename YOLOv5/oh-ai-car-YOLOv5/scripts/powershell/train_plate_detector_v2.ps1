param(
    ...
    [string]$Weights = "C:\Users\jfkyx\Desktop\YOLOv5\member_d_plate_detection\weights\yolov5s.pt",
    [string]$DataYaml = "C:\Users\jfkyx\Desktop\YOLOv5\member_d_plate_detection\configs\plate_ccpd_base1000.yaml",
    [int]$ImgSize = 640,
    [int]$BatchSize = 4,
    [int]$Epochs = 60,
    [string]$Device = "0",
...
if (-not (Test-Path $Weights)) {
    throw "Weights file not found: $Weights"
}
...
Write-Host "Training v2 finished."

...
# Import 'ultralytics' (do not auto-pip-install: broken proxies cause confusing SSL errors).
try:
    import ultralytics
    ...
    raise ModuleNotFoundError(
        ...
        "If pip fails with proxy/SSL errors, download a wheel from a PyPI mirror "
        "and run: pip install path\\to\\ultralytics-*.whl --no-deps --no-index"
    ) from exc
